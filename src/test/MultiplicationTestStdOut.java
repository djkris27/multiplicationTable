//This version of Multiplication Test is for using with Standard Out (System.out)

package test;

public class MultiplicationTestStdOut {
    private String name;
    ...
    MultiplicationTestStdOut(String getName, int maxNumber, int maxResult, int getQuantity){
        name = getName;
